...
print("USAGE: python tama_read_support_collapse_cluster.py "
      "prefix_trans_read.bed cluster_file output_file")
...
for line in cluster_file_contents:
    # iso-seq3 cluster file:
    # m54041_180706_222522.unpolished.primer_5p--primer_3p.cluster
    # from to
    ...
    # 1       5332    5907    G1.1;15_25_c122441/1/591        40      +
    # 5332    5907    255,0,0 1       575     0
    ...
    if cluster_type_flag == "v1":
        ...
        print(
            "Error: Cluster version is not recognized. Please check cluster file."
        )
        sys.exit()
...
for gene_id in gene_list:
    ...
    for trans_id in gene_trans_list:
        ...
        outline = "\t".join([
            gene_id, trans_id,
            str(gene_num_reads),
            str(trans_num_reads), cluster_line
        ])
