...
ap.add_argument('-cv', type=str, nargs=1, help='Clipped mapping variant calling: Default "clip_variants" and set to "no_clips_var" to ignore soft and hard clipping for variant detection')
