...
class Gene:
    ...
    def __init__(self, gene_line):
        ...
        # ChrC    TAIR10  gene    107599  107701  .       +       .
        # ID=ATCG00960;Name=ATCG00960;Name=ATCG00960
...
class Exon:
    ...
    def __init__(self, exon_line):
        # ChrC    TAIR10  exon    107599  107701  .       +       .
        # ID=exon:ATCG00960.1:1;Parent=ATCG00960.1
...
class Cds:
    ...
    def __init__(self, cds_line):
        ...
        self.c_start = int(
            line_split[3]) - 1  # adjust from gff 1 base to bed 0 base
...
# TODO: RK left off here. Add processing into bed format.
