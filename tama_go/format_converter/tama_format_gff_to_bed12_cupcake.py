...
class Transcript:
    ...
    def add_exon(self,e_start,e_end):
        self.num_exons += 1
        e_num = self.num_exons
...
for line in gtf_file_contents:
    ...
    #1       PacBio  transcript      14402   29804   .       -       .       gene_id "PB.1"; transcript_id "PB.1.3";
    #1       PacBio  exon    14402   14829   .       -       .       gene_id "PB.1"; transcript_id "PB.1.3";
    #1       PacBio  exon    14970   15038   .       -       .       gene_id "PB.1"; transcript_id "PB.1.3";
    #1       PacBio  exon    15796   15947   .       -       .       gene_id "PB.1"; transcript_id "PB.1.3";
    #1       PacBio  exon    16607   16768   .       -       .       gene_id "PB.1"; transcript_id "PB.1.3";
    #1       PacBio  exon    16858   17055   .       -       .       gene_id "PB.1"; transcript_id "PB.1.3";
    #1       PacBio  exon    17233   17368   .       -       .       gene_id "PB.1"; transcript_id "PB.1.3";
    #1       PacBio  exon    17606   17742   .       -       .       gene_id "PB.1"; transcript_id "PB.1.3";
    #1       PacBio  exon    17915   18061   .       -       .       gene_id "PB.1"; transcript_id "PB.1.3";
    #1       PacBio  exon    18268   18366   .       -       .       gene_id "PB.1"; transcript_id "PB.1.3";
    #1       PacBio  exon    29534   29804   .       -       .       gene_id "PB.1"; transcript_id "PB.1.3";
    ...
    if region_type == "exon":
        gene_trans_dict[gene_id][trans_id].add_exon(e_start, e_end)
