...
ncbi_trans_dict = {}
# Used to check if transcript already logged
...
for trans_id in trans_list:
    ...
    #           # correct for bed format conversion in exon class
    #           e_start = e_start + 1
    #            e_end = e_ends[j]
    ...
    if cds_flag == 1:
        ...
        if strand == "+":
            ...
            # indexing here is not corrected for by bed format; add 1 for later coord
            ...
            # bed_cds_end = start_codon_obj.bc_end + 1
            # note: bed format indexing not corrected; add 1 for later coord

        # rel_bed_cds_start = bed_cds_start - int(t_start)
        # rel_bed_cds_end = bed_cds_end - int(t_start) + 1
        # note: bed format indexing not corrected; add 1 for later coord
